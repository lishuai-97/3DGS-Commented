...
class _RasterizeGaussians(torch.autograd.Function):
    ...
    def forward( #用于定义前向渲染的规则，接受一系列输入参数，并调用 C++/CUDA 实现的 _C.rasterize_gaussians 方法进行高斯光栅化。
        ...
        args = (
            ...
            sh,
            raster_settings.sh_degree,  # 当前的激活的球谐阶数
        ...
        if raster_settings.debug:
            ...
            try:    # 在这里调用了ext.cpp的rasterize_gaussians方法，即RasterizeGaussiansCUDA
    ...
    def backward(ctx, grad_out_color, _): #方法用于定义反向传播梯度下降的规则，接受输入的梯度 
        ...
        # Restore necessary values from context，从save_for_backward取得
